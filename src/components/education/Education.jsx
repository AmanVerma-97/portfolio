  ...
  return (
    <>
        <div className=' flex flex-col justify-center items-center gap-6  w-11/12 px-6 py-2 m-auto mt-2'>
          ...
          <div id='education' className=' p-2 flex flex-col gap-5 justify-center items-center lg:flex-row lg:gap-8 lg:justify-between w-full lg:w-11/12'>
          ...
          <div id='achievement' className=' p-4 flex flex-col justify-center items-center gap-4'>
            <h1 className=' drop-shadow-lg font-bold text-2xl md:text-4xl text-black/85 underline underline-offset-4'> Achievements </h1>

            <h3 className='drop-shadow-lg font-bold text-xl md:text-2xl text-teal-600/75 '> <span className='drop-shadow-lg font-bold text-xl md:text-2xl text-gray-900/75'> 1. </span > 
            ...
            <h3 className='drop-shadow-lg font-bold text-xl md:text-2xl text-teal-600/75 '> <span className='drop-shadow-lg font-bold text-xl md:text-2xl text-gray-900/75'> 2. </span >
